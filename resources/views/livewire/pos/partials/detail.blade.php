    ...
    <div class="connect-sorting-content">
        <div class="card simple-title-task ui-sortable-handle">
            <div class="card-body">
                                ...
                                @foreach ($cart as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <h6>S/ {{ number_format($item->price * $item->quantity, 2) }}</h6>

                                        </td>
                                        <td class="text-center">
                                            <button
                                                onclick="Confirm('{{ $item->id }}','removeItem', '¿CONFIRMAS ELIMINAR REGISTRO?')"
                ...
                <div wire:loading.inline  wire:target="saveSale"> <!-- muestra la etiqueta solo cuando se esta guardando-->
